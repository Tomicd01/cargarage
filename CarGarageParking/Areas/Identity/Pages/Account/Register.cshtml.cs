...
namespace CarGarageParking.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        {
            //Ovde se kreiraju role, a u SD klasi se deklarisu
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    {
                        await _userManager.AddToRoleAsync(user, SD.Role_User_Owner);
                    }
